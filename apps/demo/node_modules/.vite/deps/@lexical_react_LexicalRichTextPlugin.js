import {
  ...
  LexicalBuilder,
  namedSignals
} from "./chunk-T4YI3DA3.js";
import {
  require_react_dom
} from "./chunk-H3V37ALB.js";
import {
  $canShowPlaceholderCurry
} from "./chunk-II75RPAI.js";
import {
  $addNodeStyle,
  ...
  mergeRegister,
  objectKlassEquals
} from "./chunk-5JXBCZ47.js";
import {
  useLexicalComposerContext
} from "./chunk-ZFIQIS7Q.js";
import {
...
} from "./chunk-SN2ER27B.js";
import {
  require_jsx_runtime
} from "./chunk-KZ2ZFOIT.js";
import {
  require_react
} from "./chunk-IHENZIGJ.js";
import {
  __toESM
...
var IS_APPLE = CAN_USE_DOM2 && /Mac|iPod|iPhone|iPad/.test(navigator.platform);
...
var IS_APPLE_WEBKIT = CAN_USE_DOM2 && /AppleWebKit\/[\d.]+/.test(navigator.userAgent) && IS_APPLE && !IS_CHROME;
  ...
  if (builder && builder.hasExtensionByName(ReactProviderExtension.name)) {
    for (const name of ["@lexical/plain-text", "@lexical/rich-text"]) {
      if (!!builder.hasExtensionByName(name)) {
        formatDevErrorMessage2(`LexicalBuilder: @lexical/react legacy text plugins conflict with the ${name} extension. Remove the legacy <RichTextPlugin/> or <PlainTextPlugin/> component.`);
      }
    }
    return true;
  }
